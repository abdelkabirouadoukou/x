  ...
  return (
    <div>
      ...
      <p className="mt-4 text-lg text-muted-foreground">
        Layouts wrap your pages with shared UI. x supports nested layouts via a dedicated layouts directory and the <span className="text-foreground">_layout.tsx</span> convention.
      </p>

      <h2 className="mt-12 text-xl font-bold tracking-tight">Layouts directory</h2>
      <p className="mt-3 text-muted-foreground">
        Configure a layouts directory in <span className="text-foreground">x.config.ts</span>. Layouts follow the same file-tree hierarchy as pages.
      </p>
...
export default defineConfig({
  ...
  layoutsDir: "src/layouts",
      ...
      <p className="mt-3 text-muted-foreground">
        The root layout wraps every page in your app. Create <span className="text-foreground">src/layouts/main.tsx</span> to add a header, footer, or global styling.
      </p>
      <CodeBlock label="src/layouts/main.tsx" code={`import type { ReactNode } from "react";
...
export default function RootLayout({ children }: { children: ReactNode }) {
  return (
    <div className="flex min-h-screen flex-col bg-background">
      ...
      <p className="mt-3 text-muted-foreground">
        Place a <span className="text-foreground">_layout.tsx</span> file inside a pages folder to create a nested layout. All pages in that folder (and subfolders) inherit it.
      </p>
  ...
  blog/
    ...
    [slug].tsx`} />
      ...
      <CodeBlock label="src/pages/blog/_layout.tsx" code={`import type { ReactNode } from "react";
...
export default function BlogLayout({ children }: { children: ReactNode }) {
  return (
    <div className="flex gap-8">
      ...
      <p className="mt-3 text-muted-foreground">
        Layouts nest hierarchically. A page under <span className="text-foreground">pages/blog/[slug].tsx</span> would be wrapped by <span className="text-foreground">blog/_layout.tsx</span> and then the root layout. The chain is resolved automatically based on the page's file path.
      </p>
