import { ArrowRight, Code2, FileJson, Globe, Layers, Zap, Shield, BarChart3, Box, RefreshCw, Server, Sparkles } from "lucide-react";

const allFeatures = [
  {
    icon: Zap, title: "One process, everything included",
  ...
  {
    icon: FileJson, title: "File-based routing",
  ...
  {
    icon: Layers, title: "Static + dynamic hybrid",
  ...
  {
    icon: Globe, title: "API routes built in",
  ...
  {
    icon: Server, title: "Server functions",
  ...
  {
    icon: Shield, title: "Type safe end to end",
  ...
  {
    icon: BarChart3, title: "Content collections",
  ...
  {
    icon: Sparkles, title: "Live reload",
  ...
  {
    icon: Box, title: "Optimized production builds",
  ...
  {
    icon: Code2, title: "Islands architecture",
  ...
  {
    icon: RefreshCw, title: "Database integration",
  ...
  {
    icon: ArrowRight, title: "Open source",
  ...
  return (
    <div className="mx-auto max-w-6xl px-6 py-20">
      <div className="mx-auto max-w-2xl text-center">
        ...
        <h1 className="mt-4 text-4xl font-bold tracking-tight sm:text-5xl">Everything you need to build for the web</h1>
      ...
      <div className="mt-16">
        <div className="rounded-3xl border border-primary/20 bg-gradient-to-b from-primary/5 to-transparent p-12 text-center sm:p-20">
          ...
          <p className="mt-4 text-lg text-muted-foreground">One command, one process, everything you need.</p>
          <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
            <a href="/docs/getting-started" className="inline-flex h-12 items-center gap-2 rounded-xl bg-primary px-6 text-sm font-semibold text-primary-foreground shadow-lg shadow-primary/25 transition-all hover:bg-primary/90">
              Get started <ArrowRight className="h-4 w-4" />
            </a>
            <a href="/docs" className="inline-flex h-12 items-center gap-2 rounded-xl border border-border bg-card px-6 text-sm font-medium text-foreground transition-all hover:bg-muted">
              Read the docs
            </a>
          </div>
        </div>
