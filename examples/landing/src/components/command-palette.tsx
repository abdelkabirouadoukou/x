...
const NAV_COMMANDS: Cmd[] = [
  ...
  { label: "Getting Started", hint: "/docs/getting-started", href: "/docs/getting-started", icon: MapPin },
  ...
  { label: "Server Functions", hint: "/docs/server-functions", href: "/docs/server-functions", icon: MapPin },
  { label: "Client Navigation", hint: "/docs/client-navigation", href: "/docs/client-navigation", icon: MapPin },
  { label: "Content Collections", hint: "/docs/content-collections", href: "/docs/content-collections", icon: MapPin },
  ...
  { label: "Configuration", hint: "/docs/configuration", href: "/docs/configuration", icon: MapPin },
  { label: "Security", hint: "/docs/security", href: "/docs/security", icon: MapPin },
  { label: "Observability", hint: "/docs/observability", href: "/docs/observability", icon: MapPin },
  ...
  { label: "GitHub", hint: "opens in a new tab", href: "https://github.com/abdelkabirouadoukou/x", icon: MapPin },
];
...
export function CommandPalette() {
  ...
  const results = useMemo(() => {
    ...
    return all.filter((c) => c.label.toLowerCase().includes(q) || c.hint.toLowerCase().includes(q)).slice(0, 9);
  }, [query]);
