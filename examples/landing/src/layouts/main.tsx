    ...
    <div className="flex min-h-screen flex-col bg-background">
      <header className="fixed top-0 z-[99] w-full border-b border-border/30 bg-background/60 backdrop-blur-2xl">
        <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-6">
          ...
          <nav className="flex items-center gap-8 text-sm font-medium text-muted-foreground">
            ...
            <a href="https://github.com/abdelkabirouadoukou/x" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 transition-colors hover:text-foreground" aria-label="GitHub repository">
      ...
      <footer className="border-t border-border/30">
        <div className="mx-auto max-w-6xl px-6 py-12 text-center text-sm text-muted-foreground">
          <span className="font-semibold text-foreground">x</span> — fullstack framework for Bun.
        </div>
      </footer>
    </div>
  );
