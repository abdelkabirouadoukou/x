...
import { AlertTriangle, Bell, Save, User } from "lucide-react";
    ...
    <div className="space-y-8">
      ...
      <div className="rounded-2xl border border-border bg-card">
        ...
        <div className="space-y-5 p-6">
          ...
          <button type="button" className="inline-flex items-center gap-2 rounded-xl bg-primary px-5 py-2.5 text-sm font-semibold text-primary-foreground shadow-lg shadow-primary/20 transition-all hover:bg-primary/90">
      ...
      <div className="rounded-2xl border border-destructive/30 bg-card">
        ...
        <div className="p-6">
          ...
          <button type="button" className="rounded-xl border border-destructive/50 bg-destructive/10 px-5 py-2.5 text-sm font-semibold text-destructive transition-all hover:bg-destructive/20">
            Delete Account
          </button>
        </div>
      </div>
